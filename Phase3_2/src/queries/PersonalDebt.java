...
public class PersonalDebt {
    private static final String QUERY = "SELECT PERSONAL_DEBT FROM PLAYER P, GAME_SESSION G WHERE P.PLAYER_KEY = G.PLAYER_KEY AND P.PLAYER_KEY = 1 AND G.GAME_END_DAY_COUNT IS NULL ORDER BY GAME_SESSION_KEY DESC FETCH FIRST ROW ONLY";
