...
public class PawnshopDebt {
    private static final String QUERY = "SELECT PAWNSHOP_DEBT FROM PLAYER P, GAME_SESSION G WHERE P.PLAYER_KEY = G.PLAYER_KEY AND P.SESSION_TOKEN = '%s' AND G.GAME_END_DAY_COUNT IS NULL ORDER BY GAME_SESSION_KEY DESC FETCH FIRST ROW ONLY";
